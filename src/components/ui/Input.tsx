...
export const inputBase =
  "rounded-sm border-[1.5px] border-line-strong bg-card px-[13px] py-2.5 text-[14px] text-ink placeholder:text-faint focus:border-green focus:outline focus:outline-2 focus:-outline-offset-1 focus:outline-green";
